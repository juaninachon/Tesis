...
La presente propuesta plantea avanzar con el análisis de las capacidades autorregulatorias a partir de la comparación e integración de información individual sobre el desempeño en tareas de funciones ejecutivas, reportes parentales y de educadores del temperamento, condiciones de vida del hogar, habilidades sociales y la observación directa de la conducta en contextos de aprendizaje. Más allá del valor predictivo que los instrumentos de laboratorio tienen sobre aspectos del desarrollo cognitivo y socioemocional a lo largo del ciclo vital, se verifica una brecha de conocimiento en cuanto a cómo se estudia la expresión ecológica de estos fenómenos. Aún no existe una comprensión integral de cómo los procesos que se evalúan con procedimientos estandarizados se ponen en juego en el hogar y la escuela para dar cuenta de diferencias en la adaptación de las personas a sus contextos de desarrollo [@moffittGradientChildhoodSelfcontrol2011]. El estudio de los procesos autorregulatorio en contextos de socialización y de educación, así como también el análisis de la validez predictiva de diferentes tipos de medidas de evaluación sobre el desempeño académico y la consideración de factores moduladores de orden individual y contextual son los temas centrales de este trabajo. La escasez de abordajes que combinen y contrasten métodos de medición, sumada a la consideración de la variabilidad cultural en el desarrollo de los procesos autorregulatorios, justifica que estos sean indagados en el ámbito local. El potencial beneficio que deriva de esta tentativa es el avance en las prácticas de evaluación que resultaría de comprender cómo indicadores comportamentales relevados en situaciones cotidianas se asocian con medidas estructuradas del funcionamiento autorregulatorio. Adicionalmente, el análisis de las diferencias individuales en estas asociaciones podría llevar a la identificación de nuevas preguntas y blancos de intervención.
...
La autorregulación (AR) es un constructo que denota al conjunto de procesos motores, emocionales y cognitivos implicados en el control de estados internos y de acciones orientadas a fines [@blairMultipleAspectsSelfregulation2015; @mcclellandDevelopmentSelfRegulation2015; @mccoyMeasuringYoungChildrens2019]. Los actos autorregulados se apuntalan en múltiples procesos que ocurren a nivel genético, epigenético, neurofisiológico, cognitivo, comportamental y socio-cultural [@baileyIntegratedModelRegulation2019; @bellBiologicalSystemsDevelopment2007; @linMeasurementSelfregulationEarly2019]. La AR propicia que las personas se adecuen y transformen las circunstancias que se les presentan en contextos como la escuela, el trabajo y las relaciones interpersonales [@bernierExternalRegulationSelfRegulation2010]. En la cotidianidad, la AR puede manifestarse en la ejecución autónoma y coordinada de rutinas y tareas domésticas (e.g., despertar, aseo, vestir, alimentación), así como también durante momentos lúdicos y de aprendizaje. En la escuela, la AR se pone en juego en todas las facetas del rol de estudiante (e.g., escuchar atentamente, seguir instrucciones y completar tareas en periodos acotados de tiempo; compartir, turnarse y colaborar con pares) [@morenoFunctionExecutiveFunction2017].
...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;La diversidad de teorías y medidas que existen para evaluar la AR ha sido señalada como muestra de que este campo de estudio adolece de un marco de referencia unificado [@karrUnityDiversityExecutive2018], pero también puede considerarse que la pluralidad de enfoques ensayados durante las últimas décadas ha enriquecido el conocimiento sobre el desarrollo autorregulatorio y lo ha consolidado como un aspecto central a ser supervisado durante la infancia y la niñez temprana. En resumen, la AR es un constructo multifacético que engloba al funcionamiento ejecutivo y a los procesos cognitivos de control, regulación conductual, emocional y atencional. En el contexto de esta tesis, todos estos términos serán empleados para hacer referencia a procesos que se ubican bajo el paraguas de la AR. 
...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;El impacto de los factores individuales y contextuales puede ser modulado no solo por su acumulación, sino además, por su co-ocurrencia y por el momento del desarrollo en el cual éstos se presentan por primera vez, su perdurabilidad en el tiempo y la susceptibilidad individual a ellos [@beckMediatorsEffectChildhood2018; @bradleySocioeconomicStatusEffects2020; @duffordChildhoodSocioeconomicStatus2021; @eastYoungAdultOutcomes2022; @ivanovicMultifactorialApproachNutritional2019; @lipinaPobreCerebroEfectos2016; @obradovicBiologicalSensitivityContext2010]. A su vez, tales factores pueden afectar a las comunidades y a las familias en su capacidad de afrontar y dar respuesta a las necesidades de desarrollo que imponen la inequidad material y social, de la cual la pobreza solo una de sus manifestaciones [@villaltaVastoCampoEstudios2014].
