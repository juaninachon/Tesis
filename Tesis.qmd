...
colnames(t17_2) <- c("Modelo", "Grados de libertad", "\\emph{RSS}", "\\emph{Chi²}", "\\emph{p}")
...
colnames(t41_2) <- c("Modelo", "Grados de libertad", "\\emph{RSS}", "\\emph{Chi²}", "\\emph{p}")
...
Este trabajo tuvo como finalidad estudiar el desarrollo autorregulatorio durante la etapa de transición a la escolaridad primaria, su vínculo con el desempeño académico y las condiciones de vida de las infancias en nuestra comunidad (ver \hyperref[tab:48]{Tabla 48}). Adicionalmente, se buscó contrastar tres enfoques de evaluación de los procesos autorregulatorios: las pruebas controladas de FFEE, el reporte de cuidadores de la conducta habitual de las niñas/os y medidas observacionales del comportamiento en contextos cotidianos. Para ello fue necesario recabar información sobre métodos observacionales e indicadores comportamentales conceptualmente vinculados a aspectos del funcionamiento autorregulatorio. Ese proceso culminó en el diseño de dos procedimientos de observación no participante, uno de los cuales se implementó en salas de cinco años de jardines de infantes y el otro, durante actividades de juego diádico semiestructurado en un museo.
...
\item Los niveles de acuerdo entre observadores sobre los indicadores conductuales fueron variados.
\end{itemize}
\tabularnewline
...
\item En el contexto aúlico, se destaca la convergencia entre el reporte docente y la observación directa de conductas prosociales y disruptivas.
\item La expresividad emocional y el nivel de involucramiento observado durante actividades de juego diádico se asoció con el reporte materno del temperamento y con el desempeño en algunas tareas de FFEE.
\end{itemize}
\tabularnewline
...
&
\begin{itemize}\itemsep0pt
\item Tanto el desempeño en tareas de FFEE como el reporte docente de habilidades sociales y la observación directa de la expresividad emocional y el involucramiento resultaron ser predictores significativos de los puntajes en las pruebas de conocimientos de lengua y matemática.
\item La edad de los niños/as, el nivel educativo materno, la disponibilidad de recursos didácticos y la frecuencia de actividades de lectura compartida en el hogar se asociaron positivamente con varias de las medidas de AR y desempeño académico.
\end{itemize}
\tabularnewline
...
&
\begin{itemize}\itemsep0pt
\item La inclusión de la edad y el nivel educativo materno en modelos multivariados disminuye el valor predictivo de algunas de las medidas de AR sobre las de desempeño académico.
